  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[60%] h-full md:bg-yellow-700/50 [clip-path:circle(80%_at_0%_50%)] ">
        <div className="max-w-full md:max-w-[28rem] pb-10 md:pb-0 flex flex-col justify-end md:justify-center items-center md:items-start  h-full px-2 xs:px-4 sm:px-6 md:px-8 text-white">
          <h1 className="text-3xl md:text-4xl  font-bold mb-2 md:mb-4 text-white  font-poppins tracking-tighter">
            Elevate Your Style
          </h1>
          <p className="text-md md:text-lg max-w-[24rem] text-center md:text-left md:max-w-full mb-4 md:mb-6 text-white font-bold md:font-medium font-calligraphy px-2">
